...
async def get_comments(
    ...
    return PaginatedResponse(
        ...
        _links=add_pagination_links(
            base_url, endpoint, page, limit, total,
            sort_by=sort_by, sort_order=sort_order, post=post, user=user
        )
    )
...
async def get_comments_by_post(
    ...
    return PaginatedResponse(
        ...
        limit=limit,
        _links=add_pagination_links(
            base_url, f"/api/v1/comments/post/{post_id}", page, limit, total,
...
async def get_comments_by_user(
    ...
    return PaginatedResponse(
        ...
        limit=limit,
        _links=add_pagination_links(
            base_url, f"/api/v1/comments/user/{user_id}", page, limit, total,
            sort_by=sort_by, sort_order=sort_order
        )
    )
