...
async def get_posts(
    ...
    return {
        ...
        "page": page,
        "limit": limit,
        "_links": add_pagination_links(base_url, "/api/v1/posts", page, limit, total, sort_by=sort_by, sort_order=sort_order, search=search)
    }
...
async def get_posts_by_user(
    ...
    return {
        ...
        "page": page,
        "limit": limit,
        "_links": add_pagination_links(base_url, f"/api/v1/posts/user/{user_id}", page, limit, total, sort_by=sort_by, sort_order=sort_order)
    }
...
async def get_posts_by_tag(
    ...
    return {
        ...
        "page": page,
        "limit": limit,
        "_links": add_pagination_links(base_url, f"/api/v1/posts/tag/{tag}", page, limit, total, sort_by=sort_by, sort_order=sort_order)
    }
