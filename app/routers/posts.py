...
async def get_posts(
    ...
    return {
        ...
        "_links": add_pagination_links(
            base_url, "/api/v1/posts", page, limit, total, sort_by=sort_by, sort_order=sort_order, search=search
        ),
    }
...
async def get_posts_by_user(
    ...
    return {
        ...
        "limit": limit,
        "_links": add_pagination_links(
            base_url, f"/api/v1/posts/user/{user_id}", page, limit, total, sort_by=sort_by, sort_order=sort_order
        ),
    }
...
async def get_posts_by_tag(
    ...
    return {
        ...
        "limit": limit,
        "_links": add_pagination_links(
            base_url, f"/api/v1/posts/tag/{tag}", page, limit, total, sort_by=sort_by, sort_order=sort_order
        ),
    }


@router.get("/{post_id}")
async def get_post(request: Request, post_id: str = Path(...), accept_language: Optional[str] = Header("en")):
...
async def create_post(request: Request, post_data: PostCreate, accept_language: Optional[str] = Header("en")):
    """Create new post"""
...
async def update_post(
    request: Request, post_id: str, post_data: PostUpdate, accept_language: Optional[str] = Header("en")
):
    """Update post"""
