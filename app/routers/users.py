...
async def create_user(user_data: UserCreate, request: Request, accept_language: Optional[str] = Header("en")):
    """Create new user"""
...
async def update_user(
    user_id: str, user_data: UserUpdate, request: Request, accept_language: Optional[str] = Header("en")
):
    """Update user"""
    # Validate user_id format
    validate_user_id(user_id)
